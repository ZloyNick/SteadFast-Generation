...
use archinheim\level\provider\AnvilChunk;
...
class NetherLava extends VariableAmountPopulator
{
        ...
        if (mt_rand(0, 100) < 5) {
            ...
            for ($i = 0; $i < $amount; ++$i) {
                ...
                if ($y !== -1 and $this->canNetherLavaStay($x, $y, $z)) {
                    ...
                    $chunk->setBlockLight($xx = ($x - ($x >> 4)), $y, $zz = ($z - ($z >> 4)), 1);
                    $this->lavaSpread($x, $y, $z, $chunk);
                }
            }
        }
    }
    ...
    private function lavaSpread($x, $y, $z, FullChunk $chunk)
    {
        /** @var AnvilChunk $chunk */
        ...
        if ($decay > 0) {
            ...
            if ($k !== $decay) {
                ...
                if ($decay < 0) {
                    ...
                    $chunk->setBlockLight($x - ($x >> 4), $y, $z - ($z >> 4), 1);
                    $this->lavaSpread($x, $y, $z, $chunk);
                    return;
                }
            }
